...
| **Priority** | P2 |
| **Status** | PARTIALLY_RESOLVED — founder decisions supplied 2026-06-03 via FAM-13B-D1. Items resolved: (1) first paid tier = STARTER; (3) billing cycle = monthly + annual; (5) grace period = 3 days; (6) non-payment action = downgrade to FREE, preserve data. Item 2: provisional prices supplied (STARTER ₹2,499/mo, PROFESSIONAL ₹4,999/mo) — CA review pending (pricing authorization for public display not yet confirmed). Item 4: GST display rule CA-CONFIRMED (2026-06-03 via FAM-13B-D2): SAC 998315, 18% GST, exclusive display confirmed. PR-03 advances to PARTIALLY_COMPLETE; Razorpay invoice SAC/GST field verification still pending before full PR-03 closure. Item 7: feature entitlement scope per tier NOT yet supplied — still PARKED. Full resolution requires: PR-03 fully closed (Razorpay invoice SAC verification complete) + PR-08 (CA pricing confirmation for public display) + feature entitlement scope defined. |
