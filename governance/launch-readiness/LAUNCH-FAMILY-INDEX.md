...
| FAM-07 | Tenant Onboarding and Invite | FAM-07E5P runtime-proof hub sync COMPLETE (2026-05-31). E5O remediation + live rerun confirmed consent scaffold persistence in LEGAL_PENDING posture (safe handoff 200 and tenant-detail observability present). Prior FAM-07I terminology reconciliation COMPLETE (2026-05-30), FAM-07G FC-03 hardening VERIFIED (6b4ebd30), sign-in-first path VERIFIED by FAM-07D3 (637326ba), and FAM-07H SMTP runtime chain COMPLETE (d93cb720). Next recommended unit: FAM-07K-CONTROL-PLANE-PROVISION-FORM-DYNAMICITY-AUDIT-001 (separate lane; no auto-merge into E5P). FAM-07 NOT VERIFIED_COMPLETE. | E5O/E5P proved LEGAL_PENDING scaffold runtime path only: activationCompleted true, legalStatus LEGAL_PENDING, consentSnapshot.present true, consentEvent.present true, tenant-detail `has_records=true` with recent `ACCEPTED_PENDING`. No LEGAL_APPROVED/legal-final state was created. FTR-LEGAL-003 remains MVP_CRITICAL/OPEN pending final legal package authority (text/version/hash/source/actor/re-consent policy) and verification. HD-001 remains RUNTIME_CONFIRMED_CONFIGURED. Overlay: FTR-AUTH-004 (PILOT_REQUIRED/P2). Out of scope: FTR-AUTH-002 (POST_MVP/BLOCKED). |
...
| FAM-07 Onboarding | LAUNCH_BLOCKER | TEST_CONFIRMED/PARTIALLY_IMPLEMENTED — E5 runtime-proof chain now recorded through FAM-07E5P (2026-05-31): E5O remediation + live rerun confirm LEGAL_PENDING consent scaffold path (safe handoff 200, tenant-detail observability records present). Prior FAM-07I terminology sync COMPLETE, FAM-07H SMTP runtime PRODUCTION_CONFIRMED, and HD-001 remains RUNTIME_CONFIRMED_CONFIGURED. FTR-LEGAL-003 MVP_CRITICAL/OPEN remains the legal launch/closure gate. E5 proof does not establish LEGAL_APPROVED/legal-final authority and does not close FAM-07. |
