...
| FAM-07 | Tenant Onboarding and Invite | TEST_CONFIRMED | FAM-07H-SMTP-SAFE-VERIFICATION-TRIGGER-RUNTIME-003-AUTHENTICATED | FAM-07H-SMTP-RUNTIME-VERIFY-CLOSE-HUB-SYNC-001 | 2026-05-30 | FAM-07I terminology reconciliation COMPLETE (2026-05-30). FTR-AUTH-001 remains PARTIAL by governance convention; sign-in-first path VERIFIED and new-user activation path hardened/tested. "Supabase invite sub-path DESIGN_GATED" wording removed as terminology drift (app-level invite-token flow confirmed). FAM-07H runtime verification chain COMPLETE with production SMTP evidence (`d93cb720`, single valid POST, `emailDelivery.status=SENT`, provider-safe proof captured). HD-001 moved from VERIFIED_BLOCKED to RUNTIME_CONFIRMED_CONFIGURED. FTR-LEGAL-003 remains MVP_CRITICAL/OPEN. FAM-07 NOT VERIFIED_COMPLETE. |
...
| FAM-07 | Tenant Onboarding and Invite | FAM-07I HUB_SYNC terminology reconciliation COMPLETE (2026-05-30). FAM-07G FC-03 hardening VERIFIED (commit 6b4ebd30). Sign-in-first path end-to-end VERIFIED by FAM-07D3 (commit 637326ba). FAM-07H SMTP runtime chain COMPLETE with production evidence (commit d93cb720). LEGAL-GATED development continuation model synchronized (2026-05-30): legal approval gates launch/legal closure, not all development continuation. Next recommended unit: FAM-07E-LEGAL-GATED-CONSENT-SCAFFOLD-DESIGN-001. FAM-07 NOT VERIFIED_COMPLETE. | FAM-07G committed (2026-05-29): FC-03 fix in App.tsx new-user onComplete handler; T-MISS-01..04 backend tests; F-MISS-01..03 / ACT-013..015 frontend tests. 21/21 backend + 15/15 frontend PASS. tsc EXIT 0. FTR-AUTH-001 PARTIAL: sign-in-first RESOLVED (D3); app-level invite-token activation path confirmed by FAM-07I repo-truth audit and terminology sync. FAM-07H runtime verification used CONTROL_PLANE_BEARER_WITH_REALM_HINT and captured production-safe provider proof. HD-001 RUNTIME_CONFIRMED_CONFIGURED (no longer VERIFIED_BLOCKED). FTR-LEGAL-003 MVP_CRITICAL/OPEN remains the legal launch gate. Legal-pending development/scaffolding is allowed under explicit LEGAL_PENDING and LAUNCH_GATED controls. Overlay: FTR-AUTH-004 (PILOT_REQUIRED/P2). Out of scope: FTR-AUTH-002 (POST_MVP/BLOCKED). Remaining units require explicit authorization. |
...
| FAM-07 Onboarding | LAUNCH_BLOCKER | TEST_CONFIRMED/PARTIALLY_IMPLEMENTED — FAM-07I terminology sync COMPLETE (2026-05-30): stale "new-user Supabase invite sub-path DESIGN_GATED" wording removed. FTR-AUTH-001 remains PARTIAL (sign-in-first verified; app-level invite activation path confirmed). FAM-07H runtime SMTP verification now PRODUCTION_CONFIRMED (`d93cb720`; single valid POST; `emailDelivery.status=SENT`; provider-safe proof captured). HD-001 RUNTIME_CONFIRMED_CONFIGURED. FTR-LEGAL-003 MVP_CRITICAL/OPEN remains the legal launch/closure gate. FAM-07 development can continue under legal-gated posture (DEV_CONTINUES + LEGAL_PENDING + LAUNCH_GATED) while final legal package stays pending. FAM-07 NOT VERIFIED_COMPLETE. |
