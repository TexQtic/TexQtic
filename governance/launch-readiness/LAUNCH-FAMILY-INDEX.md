...
| FAM-07 | Tenant Onboarding and Invite | TEST_CONFIRMED | FAM-07I-HUB-SYNC-FTR-AUTH-001-REMAINDER-TERMINOLOGY-RECONCILIATION-001 | FAM-07I-HUB-SYNC-FTR-AUTH-001-REMAINDER-TERMINOLOGY-RECONCILIATION-001 | 2026-05-30 | FAM-07I terminology reconciliation COMPLETE (2026-05-30). FTR-AUTH-001 remains PARTIAL by governance convention; sign-in-first path VERIFIED and new-user activation path hardened/tested. "Supabase invite sub-path DESIGN_GATED" wording removed as terminology drift (app-level invite-token flow confirmed). FTR-LEGAL-003 MVP_CRITICAL/OPEN. HD-001 VERIFIED_BLOCKED. FAM-07 NOT VERIFIED_COMPLETE. |
...
| FAM-07 | Tenant Onboarding and Invite | FAM-07I HUB_SYNC terminology reconciliation COMPLETE (2026-05-30). FAM-07G FC-03 hardening VERIFIED (commit 6b4ebd30). Sign-in-first path end-to-end VERIFIED by FAM-07D3 (commit 637326ba). Remaining FAM-07 units require separate Paresh authorization. FAM-07 NOT VERIFIED_COMPLETE. | FAM-07G committed (2026-05-29): FC-03 fix in App.tsx new-user onComplete handler; T-MISS-01..04 backend tests; F-MISS-01..03 / ACT-013..015 frontend tests. 21/21 backend + 15/15 frontend PASS. tsc EXIT 0. FTR-AUTH-001 PARTIAL: sign-in-first RESOLVED (D3); app-level invite-token activation path confirmed by FAM-07I repo-truth audit and terminology sync. FTR-LEGAL-003 MVP_CRITICAL/OPEN. HD-001 VERIFIED_BLOCKED (SMTP). Overlay: FTR-AUTH-004 (PILOT_REQUIRED/P2). Out of scope: FTR-AUTH-002 (POST_MVP/BLOCKED). Remaining units (FAM-07E ToS, FAM-07H SMTP infra, FAM-07J UX) require explicit authorization. |
...
| FAM-07 Onboarding | LAUNCH_BLOCKER | TEST_CONFIRMED/PARTIALLY_IMPLEMENTED — FAM-07I terminology sync COMPLETE (2026-05-30): stale "new-user Supabase invite sub-path DESIGN_GATED" wording removed. FTR-AUTH-001 remains PARTIAL (sign-in-first verified; app-level invite activation path confirmed). FTR-LEGAL-003 MVP_CRITICAL/OPEN. HD-001 VERIFIED_BLOCKED (SMTP). FAM-07 NOT VERIFIED_COMPLETE. |
