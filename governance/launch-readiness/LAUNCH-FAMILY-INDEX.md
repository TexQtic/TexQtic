...
| FAM-11 | Subscription and Commercial Gating | MAIN | CLOSE_READY | P1_MVP_MUST_HAVE | P1 | NO | 10 |
...
| FAM-11 | Subscription and Commercial Gating | PRODUCTION_CONFIRMED | FAM-11E-FAMILY-EVIDENCE-SYNC-AND-CLOSE-READINESS-001 | FAM-11E-FAMILY-EVIDENCE-SYNC-AND-CLOSE-READINESS-001 | 2026-06-03 | CLOSE_READY. All commercial tier-awareness surfaces accepted in production. Paresh verified /pricing 2026-06-03. No paid enforcement (intentional display-only MVP posture). |
...
| FAM-11 | Subscription and Commercial Gating | **CLOSE_READY** (2026-06-03) via `FAM-11E-FAMILY-EVIDENCE-SYNC-AND-CLOSE-READINESS-001`. All commercial tier-awareness display surfaces implemented and production-accepted. FREE plan display, tenant PlanAndUsagePanel, public /pricing page, CTA wiring to request-access, feature comparison accordions all confirmed. Residuals: paid enforcement future; Razorpay (FAM-13A separate track); TTP omitted (FTR-LEGAL-003 hold); paid pricing amounts pending CA/legal/founder decision. | Display-only MVP posture is intentional. No backend entitlement enforcement implemented. FAM-13A Razorpay readiness is next recommended payment-track unit. |
