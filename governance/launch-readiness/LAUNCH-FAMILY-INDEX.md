...
| FAM-07 | Tenant Onboarding and Invite | REPO_CONFIRMED | FAM-07-TENANT-ONBOARDING-OPENING-REPO-TRUTH-AUDIT-001 | LAYER0-FAM-07-AUTHORIZATION-RELEASE-001 (audit commit 402a609) | 2026-05-28 | Bounded design required (FAM-07-TENANT-ONBOARDING-BOUNDED-DESIGN-001); FTR-AUTH-001 + FTR-LEGAL-003 MVP_CRITICAL/OPEN |
...
| FAM-07 | Tenant Onboarding and Invite | Repo-truth audit COMPLETE. Next unit: FAM-07-TENANT-ONBOARDING-BOUNDED-DESIGN-001 (bounded design; requires separate Paresh authorization to open; no implementation authorized). | Repo truth confirmed via FAM-07-TENANT-ONBOARDING-OPENING-REPO-TRUTH-AUDIT-001 (commit 402a609). Authorized by LAYER0-FAM-07-AUTHORIZATION-RELEASE-001 (2026-05-28). Core gaps: FTR-AUTH-001 (reused-existing-user path, DESIGN_GATED, MVP_CRITICAL/P1); FTR-LEGAL-003 (supplier ToS gate, NOT_ASSESSED, MVP_CRITICAL/P1). Infrastructure gap: SMTP not configured in Vercel production (HD-001, VERIFIED_BLOCKED). Overlay: FTR-AUTH-004 (branded invite email, PILOT_REQUIRED/P2). Out of scope: FTR-AUTH-002 (WL onboarding, POST_MVP/BLOCKED). Implementation remains unauthorized. |
...
| FAM-07 Onboarding | LAUNCH_BLOCKER | REPO_CONFIRMED — bounded design required (FAM-07-TENANT-ONBOARDING-BOUNDED-DESIGN-001); FTR-AUTH-001 (reused-user path, MVP_CRITICAL/OPEN) + FTR-LEGAL-003 (supplier ToS, MVP_CRITICAL/OPEN) must be resolved; SMTP production gap (HD-001); implementation not authorized per LAYER0-FAM-07-AUTHORIZATION-RELEASE-001 |
