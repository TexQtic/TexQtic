...
| FAM-07 | Tenant Onboarding and Invite | TEST_CONFIRMED | FAM-07G-VERIFY-CLOSE-AND-AUTH-PATH-HUB-SYNC-001 (commit 6b4ebd30) | FAM-07G-VERIFY-CLOSE-AND-AUTH-PATH-HUB-SYNC-001 | 2026-05-29 | FAM-07G VERIFY_CLOSE COMPLETE (2026-05-29). FC-03 hardening VERIFIED. FTR-AUTH-001 PARTIAL (sign-in-first RESOLVED; new-user sub-path DESIGN_GATED remainder). FTR-LEGAL-003 MVP_CRITICAL/OPEN. HD-001 VERIFIED_BLOCKED. FAM-07 NOT VERIFIED_COMPLETE. |
...
| FAM-07 | Tenant Onboarding and Invite | FAM-07G VERIFY_CLOSE COMPLETE (2026-05-29). FC-03 hardening VERIFIED (commit 6b4ebd30). Sign-in-first path end-to-end VERIFIED by FAM-07D3 (commit 637326ba). Remaining FAM-07 units require separate Paresh authorization. FAM-07 NOT VERIFIED_COMPLETE. | FAM-07G committed (2026-05-29): FC-03 fix in App.tsx new-user onComplete handler; T-MISS-01..04 backend tests; F-MISS-01..03 / ACT-013..015 frontend tests. 21/21 backend + 15/15 frontend PASS. tsc EXIT 0. FTR-AUTH-001 PARTIAL: sign-in-first RESOLVED (D3); new-user Supabase invite sub-path DESIGN_GATED/OPEN. FTR-LEGAL-003 MVP_CRITICAL/OPEN. HD-001 VERIFIED_BLOCKED (SMTP). Overlay: FTR-AUTH-004 (PILOT_REQUIRED/P2). Out of scope: FTR-AUTH-002 (POST_MVP/BLOCKED). Remaining units (FAM-07E ToS, FAM-07H SMTP infra, FAM-07J UX) require explicit authorization. |
...
| FAM-07 Onboarding | LAUNCH_BLOCKER | TEST_CONFIRMED/PARTIALLY_IMPLEMENTED — FAM-07G VERIFY_CLOSE COMPLETE (2026-05-29, commit 6b4ebd30): FC-03 hardening VERIFIED. FTR-AUTH-001 PARTIAL (new-user sub-path DESIGN_GATED remainder). FTR-LEGAL-003 MVP_CRITICAL/OPEN. HD-001 VERIFIED_BLOCKED (SMTP). FAM-07 NOT VERIFIED_COMPLETE. |
