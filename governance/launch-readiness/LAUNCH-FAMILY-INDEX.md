...
| FAM-07 | Tenant Onboarding and Invite | TEST_CONFIRMED | FAM-07D3-TENANT-ONBOARDING-AUTHENTICATED-INVITE-ACCEPTANCE-001 (commit 637326ba) | FAM-07D3-VERIFY-CLOSE-AND-HUB-SYNC-001 | 2026-05-28 | FAM-07D3 VERIFY_CLOSE COMPLETE (2026-05-28). FTR-AUTH-001 PARTIAL (sign-in-first RESOLVED; new-user sub-path DESIGN_GATED remainder). FTR-LEGAL-003 MVP_CRITICAL/OPEN. HD-001 VERIFIED_BLOCKED. |
...
| FAM-07 | Tenant Onboarding and Invite | FAM-07D3 VERIFY_CLOSE COMPLETE (2026-05-28). Sign-in-first path end-to-end VERIFIED (17/17 backend + 12/12 frontend tests PASS, tsc EXIT 0, commit 637326ba). Remaining FAM-07 units require separate Paresh authorization. FAM-07 NOT VERIFIED_COMPLETE. | FAM-07D3 committed (2026-05-28): POST /api/tenant/activate-authenticated, acceptAuthenticatedInvite service, App.tsx pendingInviteToken trigger. FTR-AUTH-001 PARTIAL: sign-in-first sub-path RESOLVED by D3; new-user Supabase invite sub-path DESIGN_GATED/OPEN remainder. FTR-LEGAL-003 MVP_CRITICAL/OPEN (no work in D3). Infrastructure: HD-001 VERIFIED_BLOCKED (SMTP). Overlay: FTR-AUTH-004 (branded invite email, PILOT_REQUIRED/P2). Out of scope: FTR-AUTH-002 (WL onboarding, POST_MVP/BLOCKED). Remaining units (FAM-07E ToS, FAM-07F tests, FAM-07G auth hardening, FAM-07H SMTP infra, FAM-07J UX) require explicit authorization. |
...
| FAM-07 Onboarding | LAUNCH_BLOCKER | TEST_CONFIRMED/PARTIALLY_IMPLEMENTED — FAM-07D3 VERIFY_CLOSE COMPLETE (2026-05-28): sign-in-first path VERIFIED (commit 637326ba). FTR-AUTH-001 PARTIAL (new-user sub-path DESIGN_GATED remainder). FTR-LEGAL-003 MVP_CRITICAL/OPEN. HD-001 VERIFIED_BLOCKED (SMTP). FAM-07 NOT VERIFIED_COMPLETE. |
