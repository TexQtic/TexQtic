...
**Authority:** governance/control/TEXQTIC-OPENING-LAYER-GOVERNANCE-AUTHORITY-AND-POINTER-LAYER-2026-04-10.md · **Updated:** 2026-06-05 (FTR-SL-001D COMPLETE. Shraddha Industries publish+reinvite activated in production. POST /publish → 200 B2B_PUBLIC; POST /reinvite → 200 emailDispatched:true; GET /api/public/supplier/shraddha-industries → 200; directory total:2. FTR-SL-001E consent scaffold fix. FTR-SL-001F live reinvite executed on 2026-06-05. FTR-SL-001G runtime failure root cause identified and fixed: withDbContext switches to texqtic_app role (NOBYPASSRLS); users table has no INSERT policy for texqtic_app; user.create moved to native postgres connection before withDbContext. 30/30 backend + 21/21 frontend tests pass. Final enum: FTR_SL_001D_SHRADDHA_PUBLISH_REINVITE_ACTIVATED. Prior: FTR-SL-001C COMPLETE 2026-06-04.)
