...
**Authority:** governance/control/TEXQTIC-OPENING-LAYER-GOVERNANCE-AUTHORITY-AND-POINTER-LAYER-2026-04-10.md · **Updated:** 2026-06-06 (FTR-SL-001M runtime truth + public supplier regression triage. Preflight PASS (branch main, HEAD a5db3e14, clean working tree). GET /api/health → 200 (timestamp 2026-06-06T01:40:54.713Z; no SHA exposed in payload). PUBLIC SUPPLIER REGRESSION CONFIRMED: GET /api/public/supplier/shraddha-industries → 404 NOT_FOUND code="NOT_FOUND" message="Supplier not found". Directory also regressed: GET /api/public/b2b/suppliers → total:1 (lt-b2b-001 only; Shraddha absent) — matches pre-FTR-SL-001D pre-publish baseline (was total:2 in FTR-SL-001D and total:2 in FTR-SL-001L). Source code commits between 25df4f4e and a5db3e14 are governance-only; route /api/public/supplier/:slug and service getPublicB2BSupplierBySlug code are unchanged and correct. Regression is DATA STATE in production DB: publication_posture or publicEligibilityPosture reverted for tenant 0ae549d7-b17b-4277-b9f6-f3e8c3a57e09. Control-plane auth probe not attempted (prior run a5db3e14 confirmed 401; no new SUPER_ADMIN session available). Deployed SHA cannot be confirmed from available runtime payloads. Final enum: FTR_SL_001M_BLOCKED_PUBLIC_SUPPLIER_REGRESSION_CONFIRMED. Recommended next unit: human-assisted SUPER_ADMIN session restore + re-execute POST /api/control/tenants/0ae549d7-b17b-4277-b9f6-f3e8c3a57e09/publish to restore B2B_PUBLIC/PUBLICATION_ELIGIBLE state. Prior: FTR-SL-001L BLOCKED_REINVITE_API_FAILED.)
