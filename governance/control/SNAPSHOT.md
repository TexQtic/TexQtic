...
**1 governed unit is currently OPEN.** The sole OPEN unit is clarification-only: `TECS-FBW-ADMINRBAC-NEXT-MUTATION-CLARIFICATION-001`. 0 implementation units are OPEN; 0 BLOCKED · 0 DEFERRED · 1 DESIGN_GATE.
