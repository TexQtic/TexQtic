...
**Last Updated:** 2026-03-18 (GOVERNANCE-SEQUENCE-RFQ-DOMAIN-001)
...
|---|---|---|---|---|
| TECS-RFQ-DOMAIN-001 | RFQ domain persistence — canonical entity + write path | OPEN | W5 | 2026-03-18 |
...
TECS-RFQ-DOMAIN-001 is now the single implementation-ready RFQ follow-on unit.
