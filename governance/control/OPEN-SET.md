...
**Last Updated:** 2026-03-20 (GOV-DEC-G026-CLEANUP-REMEDIATION-OPENING)
...
|---|---|---|---|---|
| TECS-G026-CLEANUP-REMEDIATION-001 | Remove or re-home non-routing texqtic_service dependencies before any routing opening | OPEN | W4 | 2026-03-20 |
...
TECS-G026-CLEANUP-REMEDIATION-001 is now OPEN as the sole bounded next governed G-026 step for removing or re-homing the non-routing `texqtic_service` dependencies on `memberships`, `users`, `catalog_items`, and `rfq_supplier_responses`. Broad G-026 routing remains unopened and no routing implementation-ready G-026 stream is OPEN.
