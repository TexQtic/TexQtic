...
- [x] G-007 — Fix `supabase_hardening.sql` `set_config(..., false)` → `true` (transaction-local, pooler-safe) — **VALIDATED `09365b2`** — 6 substitutions in 3 SQL helper fns; DB applied + pg_get_functiondef verified; T1 admin 200 ✅; T2 control 200 ✅; T3 context OK ✅
