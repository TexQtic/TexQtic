...
| G-027  | The Morgue (Level 1+ failure event bundles) — schema foundation complete | IN PROGRESS (schema foundation) | L scope; post-mortem + regulator review — `morgue_entries` table + canonical RLS applied 2026-03-03 (GOVERNANCE-SYNC-065) |
