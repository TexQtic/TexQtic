...
| G-026  | Custom domain routing / tenant resolution (white-label) | **TECS 6C1 ✅ Validated (GOVERNANCE-SYNC-090) — TECS 6C2/6C3/6D pending** | L scope; D1=Hybrid Edge+Backend; D2=platform subdomains v1 (<slug>.texqtic.app); D3=HMAC resolver endpoint; D4=texqtic_service BYPASSRLS narrow; D5=60s Edge TTL cache; D6=internal signed contract; D7=x-texqtic-* headers; D8=fail-closed; G-026-A deferred v1.1; G-026-H ✅ VALIDATED (migration applied); TECS 6C2/6C3/6D queued |
