...
Last Updated: 2026-03-10 (GOVERNANCE-SYNC-OPENAPI-POLICY-DECISION-GOV — OPENAPI-AI-SCOPE-001 ✅ CLOSED / RESOLVED (policy decision): /api/ai/* retained in tenant OpenAPI scope as tenant-consumable cross-cutting product routes · OPENAPI-IMPERSONATION-DOC-001 ✅ CLOSED / RESOLVED (policy decision): impersonation routes intentionally excluded from public control-plane OpenAPI due to sensitive SUPER_ADMIN operational scope; no OpenAPI files modified; no product code changed; governance blocker removed; next sequenced unit: PW5-W3 backend design)
...
Recommended immediate next unit: **PW5-W3 backend design** — define `GET /api/control/settlements` read route (Settlement Admin, three-layer absence: no AdminView token · no component · no GET route). Governance blocker removed: OPENAPI-AI-SCOPE-001 ✅ RESOLVED (policy decision) · OPENAPI-IMPERSONATION-DOC-001 ✅ RESOLVED (policy decision) · OPENAPI-POLICY-DECISION-GOV ✅ COMPLETE (2026-03-10). (PW5-W2 ✅ · PW5-W4 ✅ CLOSED · PW5-W3 🔴 BACKEND DESIGN GATE · PW5-CP-PLAN ✅ COMPLETE · SPEC-SYNC ✅ COMPLETE)
