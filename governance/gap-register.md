...
| **G006C-EVENT-LOGS-CLEANUP-001** | event_logs: DROP 2 orphan PERMISSIVE ALL deny policies (anon + authenticated) | 🔲 NOT STARTED | Pre-req: G006C-ORDERS-GUARD-001 COMPLETE (now satisfied) | Cleanup only — no security risk; Supabase Performance Advisor noise |
