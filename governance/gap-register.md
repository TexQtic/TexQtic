...
Last Updated: 2026-03-05 (GOVERNANCE-SYNC-087 — G-025-DPP-API-UI-MANUFACTURER-ENABLE-001 → ✅ VALIDATED: tenant.ts DPP handler updated — SELECT now includes manufacturer_name/jurisdiction/registration_no from view; manufacturer fields added to product response object; meta.manufacturerFields sentinel removed; DPPPassport.tsx updated — amber omission banner removed; manufacturer sub-section added to Product Identity card (renders value or ‘Manufacturer details unavailable’); omission note div removed; server typecheck EXIT 0; lint EXIT 0; G-025 DPP end-to-end manufacturer fields fully enabled; GOVERNANCE-SYNC-087)
