...
|---|---|---|---|---|---|---|---|---|---|
| TECS-FBW-001 | Finance/Compliance/Dispute Mutations | Admin authority | §5.1 pending | F-009 absent | RECONFIRMED | Compliance: ✅ CLOSED (GOVERNANCE-SYNC-107 · 2026-03-07); Finance: ⏳ Pending; Disputes: ⏳ Pending | HIGH | Wave 2 | Compliance slice: approveComplianceRequest+rejectComplianceRequest in controlPlaneService.ts; adminPostWithHeaders SAME-UNIT EXPANSION in adminApiClient.ts; confirm dialog + idempotency-key in ComplianceQueue.tsx; typecheck+lint EXIT 0; FinanceOps+DisputeCases remain pending |
