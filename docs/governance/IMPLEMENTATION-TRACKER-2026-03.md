...
| PW5-W3-FE | Control-plane Settlement admin frontend wiring | ⏳ PENDING | Settlement Admin frontend component, AdminView token, and shell nav wiring remain pending. Depends on PW5-W3-BE (✅ CLOSED 2026-03-12). Do not begin until PW5-W3-FE is explicitly sequenced. |
...
**PW5-W3-FE — Settlement Admin frontend wiring**  
Reason: PW5-W3 backend read surface complete — commit 14aea49 · `GET /api/control/settlements` implemented · control-plane OpenAPI updated · backend design gate removed — 2026-03-12 (GOVERNANCE-SYNC-PW5-W3-GOV). Settlement Admin frontend component, AdminView token, and shell nav wiring remain pending. Deferred items remain deferred: tenant logout (DEF-003), B2B avatar (DEF-004), B2C search (DEF-005), WL storefront completion (PW5-WL1..3), DPP backend audit.
