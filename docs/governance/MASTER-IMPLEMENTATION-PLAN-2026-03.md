...
| G-028 AI separation — insight caching / vector store / inference service split | XL | Medium | Possibly: vector table schema; depends on AI infrastructure choice | `OPS-G028-AI-INFRASTRUCTURE-001` |
