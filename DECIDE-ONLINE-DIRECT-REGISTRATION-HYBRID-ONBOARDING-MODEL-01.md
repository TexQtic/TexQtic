...
| 3 | `DESIGN-MAINAPP-GST-KYC-AUTOMATION-HYBRID-WITH-ADMIN-FALLBACK-01` | COMPLETE | `5625b57c` |
| 4 | `IMPL-MAINAPP-GST-KYC-PROVIDER-INTEGRATION-AND-EVIDENCE-CAPTURE-01` | PRODUCTION_VERIFIED — Deepvue active; RLS fix `d45272cd`; timeout fix `4adc8500`; smoke verified 2026-06-09 | `4adc8500` |
