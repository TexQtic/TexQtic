    ...
    <div className="space-y-8 max-w-4xl">
      <div>
        ...
        <p className="text-slate-400 text-sm">
          Concise definition of platform-level domain endpoints.
        </p>
      </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden divide-y divide-slate-800">
            {domain.endpoints.map((ep, i) => {
              ...
              return (
                <div
                  key={i}
                  className="p-4 flex items-center gap-6 hover:bg-slate-800/20 transition-colors group"
                >
                  <div
                  ...
                  <div className="text-xs text-slate-500 ml-auto group-hover:text-slate-300 transition-colors">
                    {ep.desc}
                  </div>
                </div>
              );
