/**
 * rfq-assist-suggestions.test.ts â€” RFQ Assist Suggestions Parser Tests
 *
 * Tests parseRfqAssistSuggestions() for:
 * - Valid JSON response â†’ ok: true, typed suggestions
 * - Markdown code-fenced JSON â†’ ok: true (fence stripping)
 * - Code fence preceded by prose â†’ ok: true
 * - Whitespace-surrounded JSON â†’ ok: true
 * - Prose before/after JSON object â†’ ok: true
 * - Invalid JSON â†’ ok: false, parseError: true
 * - Array output â†’ ok: false, parseError: true
 * - Multiple top-level JSON objects â†’ ok: false, parseError: true
 * - Missing reasoning field â†’ uses default empty string (Zod default)
 * - Urgency enum validation â†’ only STANDARD | URGENT | FLEXIBLE
...
// â”€â”€â”€ Shared valid payload â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ parseRfqAssistSuggestions â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
describe('parseRfqAssistSuggestions', () => {
  ...
  it('returns ok:false parseError:true for multiple top-level JSON objects', () => {
    // Two adjacent JSON objects â€” standard JSON.parse rejects this
  ...
  it('returns ok:true when reasoning exceeds 1000 characters (verbose Gemini output)', () => {
    // Gemini often returns 1500+ char reasoning; old max(1000) caused false 422s
    const longReasoning = 'Based on the catalog item and RFQ context, '.repeat(50); // ~2100 chars
    const raw = JSON.stringify({ requirementTitle: 'Fabric', reasoning: longReasoning });
    const result = parseRfqAssistSuggestions(raw);
    expect(result.ok).toBe(true);
    if (!result.ok) return;
    expect(result.suggestions.reasoning.length).toBeGreaterThan(1000);
  });
});

// â”€â”€â”€ normalizeModelJsonOutput â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ rfqAssistSuggestionsSchema â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
